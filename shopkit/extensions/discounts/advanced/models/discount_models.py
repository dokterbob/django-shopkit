...
from shopkit.extensions.discounts.settings import \
    COUPON_LENGTH, COUPON_CHARACTERS

from datetime import datetime

from shopkit.core.settings import PRODUCT_MODEL
from shopkit.core.utils.fields import PercentageField
...
try:
    from shopkit.extensions.category.settings import CATEGORY_MODEL
    CATEGORIES = True
except ImportError:
