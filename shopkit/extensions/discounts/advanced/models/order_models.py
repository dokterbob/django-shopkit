...
from shopkit.extensions.discounts.settings import COUPON_LENGTH

from shopkit.extensions.discounts.basemodels import \
    DiscountedCartBase, DiscountedCartItemBase, \
    DiscountedOrderBase, DiscountedOrderItemBase

from shopkit.extensions.discounts.settings import DISCOUNT_MODEL
